...
and distance to coral habitat (right) effects on resilience. Estimates
(and confidence intervals) were evaluated at the means of all other
numeric variables and for the ZMHU species in the Central zone.}
...
\item
  The remaining variables (seagrass area, bathymetry slope, seagrass
  distance, zone class, habitat count, mangrove area, and coral area)
  had notable drop offs in performance.
\end{itemize}
...
cover as a function of distance to coral habitat.}
