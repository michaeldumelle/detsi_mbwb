...
* The remaining variables (seagrass area, bathymetry slope, seagrass distance, zone class, habitat count, mangrove area, and coral area) had notable drop offs in performance.
