...
#| fig-cap: "Residuals for reslience analysis in Wide Bay by financial year."
...
res_vars <- tibble(
  ...
  Included = if_else(Variable %in% c("Seagrass Habitat Total Area", "Bathymetry Mean Curvature"), "No", "Yes"),
...
* Distance from coral habitat was fifth-most important, with a similar trend quadratic trend (@rf_coral) as in the spatial linear model.
